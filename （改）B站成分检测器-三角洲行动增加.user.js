// ==UserScript==
// @name              （改）B站成分检测器-三角洲增强版
// @version           3.0.0
// @author            hmjz100,xulaupuz,trychen,Medrovsky
...
// @homepage          https://github.com/Medrovsky/bilibili-comment-checker_-delataforce
// @supportURL        https://github.com/Medrovsky/bilibili-comment-checker_-delataforce/issues
// @match             *://*.bilibili.com/*
...
(function BiliChecker() {
	...
	const checkers = [
		...
		{
			displayName: "三角洲",
			displayIcon: "https://i1.hdslb.com/bfs/face/3ca379272bb4ccfa8bc69f2aef1e4a5d6d330f47.jpg@128w_128h_1c_1s.webp",
			keywords: ["三角洲", "三角洲行动", "超雄老太", "赛伊德", "超雄老太", "雷斯", "M700", "航天基地", "大坝", "长弓", "非洲之心", "航天燃油", "威龙", "麦小雯", "乌鲁鲁", "红狼", "深蓝","蜂医","牧羊人","绝密","蛊","老飞宇"],
			followings: [
				3494376565115651, // 三角洲行动
				3493274574653579, // 白泽
				3546709057604541, // 清空
				357757883, // 老马
				2033313166, // 心叶
				403637371, // 78
				19525533, // 77,可能与MC有冲突
				11332884, // 725
				3537119932844651, // qiansui
				11703718, // miermiru
				6810019, // anke
				295099243, // lingugu
				52717408, // alwayscc
